...
public class KosleniumDriverTest {
	...
	public void testDetectCaptchaFindsGoogleBypass() {
		...
		assertNotNull(KosleniumDriver.detectCaptcha(html));
	}
	...
	public void testDetectCaptchaPassesCleanPage() {
		...
		assertNull(KosleniumDriver.detectCaptcha(html));
	}
	...
	public void testPrintLinksExtractsAnchors() {
		...
		try {
			KosleniumDriver.printLinks(html);
	...
	public void testPrintTextStripHtml() {
		...
		System.setOut(new PrintStream(out));
		try {
			KosleniumDriver.printText(html);
			String s = out.toString();
	...
	public void testLoadConfigValue() throws IOException {
		...
		String val = KosleniumDriver.loadConfigValue(cfg.toString(), "selector", "default");
		assertEquals("#main", val);
	}

	@Test
	public void testLoadConfigValueDefault() {
		String val = KosleniumDriver.loadConfigValue("nonexistent.json", "selector", "default");
	...
	public void testLoadConfigLong() throws IOException {
		...
		long val = KosleniumDriver.loadConfigLong(cfg.toString(), "waitMs", 1000);
		assertEquals(5000, val);
	}

	@Test
	public void testLoadConfigLongDefault() {
		long val = KosleniumDriver.loadConfigLong("nonexistent.json", "waitMs", 1000);
	...
	public void testLoadTimeout() throws IOException {
		...
		int t = KosleniumDriver.loadTimeout(cfg.toString());
		assertEquals(15, t);
	}

	@Test
	public void testLoadTimeoutDefault() {
		int t = KosleniumDriver.loadTimeout("nonexistent.json");
		assertEquals(KosleniumDriver.DEFAULT_TIMEOUT, t);
	}
	...
	public void testLoadUserAgentFromConfig() throws IOException {
		...
		String ua = KosleniumDriver.loadUserAgent(cfg.toString(), null);
		assertEquals("MyBot/1.0", ua);
	}

	@Test
	public void testLoadUserAgentCliOverride() {
		String ua = KosleniumDriver.loadUserAgent("nonexistent.json", "CLI/2.0");
		assertEquals("CLI/2.0", ua);
	}

	@Test
	public void testLoadUserAgentDefault() {
		String ua = KosleniumDriver.loadUserAgent("nonexistent.json", null);
		assertEquals(KosleniumDriver.DEFAULT_UA, ua);
	}
	...
	public void testCleanUrlGoogle() {
		String cleaned = KosleniumDriver.cleanUrl("/url?q=https%3A%2F%2Fexample.com&sa=U&ved=2ahUKEwj");
		assertEquals("https://example.com", cleaned);
	}

	@Test
	public void testCleanUrlRelative() {
		String cleaned = KosleniumDriver.cleanUrl("/some/path");
		assertTrue(cleaned.startsWith("(relative)"));
	}

	@Test
	public void testCleanUrlProtocolRelative() {
		String cleaned = KosleniumDriver.cleanUrl("//example.com/path");
