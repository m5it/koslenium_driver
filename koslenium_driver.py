#!/usr/bin/env python3
"""
koslenium_driver.py — Minimal Selenium-like driver for koslenium_driver JavaFX WebView server.

Auto-starts the koslenium_driver socket server on first use and shuts it down on quit().
...
class WebDriver:
    """
    Lightweight Selenium-style driver backed by the koslenium_driver JavaFX socket server.
    """
    ...
    def _find_run_sh(self):
        ...
        raise WebDriverError("run.sh not found. Please ensure koslenium_driver is built.")
...
if __name__ == "__main__":
    print("koslenium_driver.py is a library. Run examples/ scripts or import WebDriver from your code.")
